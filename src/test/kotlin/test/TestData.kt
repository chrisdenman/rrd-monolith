...
class TestData {
    companion object {
        ...
        const val POST_CODE_SEARCH_TERM_PROPERTY_NAME = "POST_CODE_SEARCH_TERM"
        const val START_URL_PROPERTY_NAME = "START_URL"
        const val STREET_NAME_SEARCH_TERM_PROPERTY_NAME = "STREET_NAME_SEARCH_TERM"
        const val WAIT_DURATION_SECONDS_PROPERTY_NAME = "WAIT_DURATION_SECONDS"
        const val DRIVER_PROPERTY_PROPERTY_NAME = "DRIVER_PROPERTY"
        const val DRIVER_LOCATION_PROPERTY_NAME = "DRIVER_LOCATION"
        const val DRIVER_OPTIONS_PROPERTY_NAME = "DRIVER_OPTIONS"
        const val HTML_INPUT_GATEWAY_PROPERTY_VALUE = "HtmlInputGateway"
        const val CALENDAR_OUTPUT_GATEWAY_PROPERTY_VALUE = "CalendarOutputGateway"
        const val XLSX_INPUT_GATEWAY_PROPERTY_VALUE = "XlsxInputGateway"
        ...
        val POST_CODE_SEARCH_TERM_LENGTH_RANGE = 5..50
        val DRIVER_PROPERTY_LENGTH_RANGE = 1..200
        val DRIVER_OPTIONS_LENGTH_RANGE = 0..1000

        val WAIT_DURATION_SECONDS_BOUNDS_RANGE = 1..Long.MAX_VALUE
